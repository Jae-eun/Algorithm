//
//  backjoon_15904.swift
//  algo
//
//  Created by 이재은 on 2020/10/08.
//  Copyright © 2020 이재은. All rights reserved.
//

import Foundation

//backjoon 15904 UCPC는 무엇의 약자일까?
...
for i in 0..<text.count {
    first.append(contentsOf: text[i].filter { $0.isUppercase })
}

var index = 0
for char in first {
    if String(char) == UCPC[index] {
        index += 1
    }
    if index == 4 {
        print("I love UCPC")
