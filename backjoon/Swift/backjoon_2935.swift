...
let A = readLine()!.filter { $0 == "0" }.count
let oper = readLine()!
let B = readLine()!.filter { $0 == "0" }.count

if oper == "*" {
    print("1" + String(repeating: "0", count: A + B))
} else {
    if A > B {
        print("1" + String(repeating: "0", count: A - B - 1) + "1" + String(repeating: "0", count: B))
    } else if A < B {
        print("1" + String(repeating: "0", count: B - A - 1) + "1" + String(repeating: "0", count: A))
    } else {
        print("2" + String(repeating: "0", count: A))
    }
}
